...
acc_rand <- select(acc_rand, -Astronomical_Twilight, -Nautical_Twilight)
...
full_model <- fit(lm_spec,
                  Severity ~ .-State-Civil_Twilight-Weather_Condition, 
                  data = acc_rand)
...
penalty_grid <- grid_regular(
  penalty(range = c(0, -3)), #log10 transformed (e.g., put '-3' for 0.001) 
  levels = 30)
...
final_fit <- fit(final_wf, data = acc_rand)
tidy(final_fit)
```
